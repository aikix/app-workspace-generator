...
async function generateRootFiles(targetDir: string, context: TemplateContext): Promise<number> {
  ...
  if (context.backend === 'firebase') {
    operations.push(
      {
        type: 'template',
        source: 'web/apphosting.yaml.hbs',
        destination: 'apphosting.yaml',
        context,
      },
      {
        type: 'template',
        source: 'web/apphosting.dev.yaml.hbs',
        destination: 'apphosting.dev.yaml',
        context,
      },
      {
        type: 'template',
        source: 'web/apphosting.prod.yaml.hbs',
        destination: 'apphosting.prod.yaml',
        context,
      },
      {
        type: 'copy',
