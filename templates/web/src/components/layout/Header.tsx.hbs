...
/**
 * Header component - Main navigation header with auth
 *
 * Features:
  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="text-xl font-bold hover:text-primary transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded"
          aria-label="{{pascalCase projectName}} home"
        >
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          ...
          <SheetContent side="right" className="w-[300px] sm:w-[400px]">
            <SheetHeader>
              <SheetTitle>{{pascalCase projectName}}</SheetTitle>
